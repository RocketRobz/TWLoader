...
static u8 bnriconframeseq[22][128] = {0x00};
...
static u8 bannerDelayNum[22] = {0x00};
...
void playBannerSequence(int iconnum) {
	if(bannerDelayNumGot[iconnum]==false) {
		bnriconframenum[iconnum] = bnriconframeseq[iconnum][currentbnriconframeseq[iconnum]];
		bannerDelayNumGot[iconnum] = true;
	} else {
		bannerDelayNum[iconnum]++;
		if(bannerDelayNum[iconnum] == bnriconframeseq[iconnum][currentbnriconframeseq[iconnum]+1]) {
			bannerDelayNum[iconnum] = 0x00;
			currentbnriconframeseq[iconnum] += 2;
			if(bnriconframeseq[iconnum][currentbnriconframeseq[iconnum]] == 0x00
			&& bnriconframeseq[iconnum][currentbnriconframeseq[iconnum]+1] == 0x00) {
