...
size_t boxtex = 87; 
size_t shoulderLtex = 88; 
size_t shoulderRtex = 89;
size_t voltex[6] = {90, 91, 92, 93, 94, 95};
size_t batteryIcon = 96; 
size_t batterychrgtex = 97;
size_t batterytex[6] = {98, 99, 100, 101, 102, 103};
...
size_t setvoltex[6] = {145, 146, 147, 148, 149, 150};
size_t setbatterychrgtex = 151;
size_t setbatterytex[6] = {152, 153, 154, 155, 156, 157};
size_t dsboottex = 158;
size_t dsiboottex = 159;
size_t invdsboottex = 160;
size_t invdsiboottex = 161;
size_t dshstex = 162;
size_t dsihstex = 163;
size_t disabledtex = 164;
size_t settingstex = 165;
size_t settingslogooadertex = 166;
size_t new_tex = 167;
size_t gbctex = 168;
