...
static const char *const lang_IT[STR_MAX] = {
	...
	"Immagine personalizzata inferiore",                       // "Custom bottom image"
	"Auto aggiorna il bootstrap",                               // "Auto-update bootstrap"
	"Auto aggiorna a ultimo TWLoader",                           // "Auto-update to latest TWLoader"
	...
	"Il tema usato in TWLoader.",                               // "The theme to use in TWLoader."
	"Premi A per i sotto-temi.",                               // "Press A for sub-themes."

	"I colori dello sfondo superiore ,",                       // "The color of the top background,"
	"del bordo dello START, e dei puntidi contorno.",           // "the START border, and the circling dots."
	...
	"Il numero dei giochi selezionati e elencati ",               // "A number of selected game and listed games"
	...
	"Auto-aggiorna nds-bootstrap all'avvio.",                   // "Auto-update nds-bootstrap at launch."
	"",															// (empty)

	"Auto-scarica all'avvio l'ultima",                           // "Auto-download the CIA of the latest"
	"versione del TWLoader CIA.",                               // "TWLoader version at launch."
	...
	"Imposta a TWL per eliminare il lag su alcuni giochi.",       // "Set to TWL to get rid of lags in some games."
	"",															// (empty)
	
	"Abilita la scrittura della VRAM a 8 bit",                   // "Allows 8 bit VRAM writes"
	"e expande il bus a 32 bit.",                               // "and expands the bus to 32 bit."
