...
static const char *const lang_ES[STR_MAX] = {
	...
	"ANTES DE COMENZAR A JUGAR, LEE CON ATENCION EL",			// "BEFORE PLAYING, READ THE HEALTH"
	"FOLLETO DE PRECAUCIONES SOBRE SALUD Y SEGURIDAD,",			// "AND SAFETY PRECAUTIONS BOOKLET"
	"EN EL QUE SE RECOGE INFORMACION IMPORTANTE",				// "FOR IMPORTANT INFORMATION"
	...
	"A TU ZONA, VISITA ESTA PAGINA WEB:",
	"www.nintendo.com/healthandsafety/",						// "www.nintendo.com/healthandsafety/"
	
	"Toca la pantalla tactil para continuar.",					// "Touch the Touch Screen to continue."
